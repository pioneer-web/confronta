...
urlpatterns = [
    ...
    path(
        ...
        auth_views.PasswordResetView.as_view(
            template_name='aplicativo/password_reset_form.html',
            email_template_name='aplicativo/emails/password_reset_email.txt',
            subject_template_name='aplicativo/emails/password_reset_subject.txt',
            success_url=reverse_lazy('aplicativo:password_reset_done'),
        ),
        name='password_reset',
    ),
    path(
        ...
        auth_views.PasswordResetDoneView.as_view(
            template_name='aplicativo/password_reset_done.html',
        ),
    ...
    path(
        ...
        auth_views.PasswordResetConfirmView.as_view(
            template_name='aplicativo/password_reset_confirm.html',
            success_url=reverse_lazy('aplicativo:password_reset_complete'),
        ),
    ...
    path(
        ...
        auth_views.PasswordResetCompleteView.as_view(
            template_name='aplicativo/password_reset_complete.html',
        ),
