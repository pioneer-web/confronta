...
PRODES_DATASETS = (
    ...
    _spec(
        ...
        'Amazônia',
        ('amazonia', 'amazon', 'nao_florestal', 'non_forest', 'no_forest', 'supressao', 'prodes'),
        'AMAZONIA',
        'SUPRESSAO_NAO_FLORESTAL',
        ('yearly_deforestation_nf_biome_amazonia', 'yearly_deforestation_non_forest_biome_amazonia', 'no_forest_amazonia_legal'),
    ),
    _spec(
        'prodes-cerrado-supressao',
        'Cerrado — Incremento anual na supressão',
        'Cerrado',
        ('cerrado', 'supressao', 'prodes', 'yearly_deforestation'),
        'CERRADO',
        'SUPRESSAO_VEGETACAO_NATIVA',
        ('yearly_deforestation_biome_cerrado', 'prodes_biome_cerrado'),
    ),
    _spec(
    ...
    _spec(
        ...
        'Caatinga',
        ('caatinga', 'supressao', 'prodes', 'yearly_deforestation'),
        'CAATINGA',
        'SUPRESSAO_VEGETACAO_NATIVA',
        ('yearly_deforestation_biome_caatinga', 'prodes_biome_caatinga'),
    ),
    _spec(
